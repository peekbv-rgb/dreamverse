...
(function () {
   ...
   *
   * De nummers staan in `static/zorg.js` en niet meer hier: sinds de gratis
   * duiding bestaat, duidt `welkom.html` ook een droom, en twee lijsten met
   * crisisnummers naast elkaar is precies de fout die je hier niet mag maken.
   * De drie regels waaraan die lijst moet voldoen staan in dat bestand.
   *
   * Boven de duiding, niet eronder: wie dit nodig heeft moet het zien voordat
   * hij begint te lezen.
   */
  function toonZorg(ep) {
    ...
    var html = window.Zorg ? Zorg.kaderHtml((ep && ep.zorg) || [], taal) : "";
    doos.innerHTML = html;
    doos.hidden = !html;
  }
