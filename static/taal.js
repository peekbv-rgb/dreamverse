...
(function () {
  ...
  [
    ...
    ["De spraakdienst van je toestel doet niet mee. Op een iPhone komt dat meestal door een privévenster, of doordat Dicteren uitstaat bij Instellingen, Algemeen, Toetsenbord.",
     "Your device will not hand over its speech service. On an iPhone that is usually a private window, or Dictation being switched off under Settings, General, Keyboard."],
    ["De microfoon is geweigerd. Zet hem aan bij de site-instellingen van je browser.",
     "The microphone was refused. Turn it on in your browser's site settings."],
    ["Er is geen microfoon gevonden.", "No microphone was found."],
    ["Spraak naar tekst kon het net niet op. Op een bedrijfsnetwerk zit daar soms een firewall tussen.",
     "Speech to text could not reach the network. On a company network there is sometimes a firewall in the way."],
    ...
    ["Er staat nog geen beeld bij deze droom om te delen.",
     "There is no image with this dream yet to share."],
    ["Houd het beeld ingedrukt om het te bewaren, en zet het daarna in je verhaal.",
     "Press and hold the image to save it, then put it in your story."],
    ["Opslaan", "Save"],
    ["Sluiten", "Close"],
    ...
    ["Waar deze droom je aandacht op kan vestigen", "What this dream may be pointing toward"],
    ...
    ["Toen:", "Then:"],
    ["Nu:", "Now:"],
    ["Dit is je dromendagboek: wat er door al je nachten heen loopt.",
     "This is your dream diary: what runs through all your nights."],
    ...
    ["dagen geleden. Heb je het teruggezien?", "days ago. Did you notice it?"],
    ["Je zei dat je dit hebt teruggezien.", "You said you noticed this."],
    ["Je zei dat je hier iets van hebt teruggezien.", "You said you noticed some of this."],
    ...
    ["Je Dreamverse begint vorm te krijgen.", "Your Dreamverse is beginning to take shape."],
    ["Ontgrendel je hele Dreamverse", "Unlock your complete Dreamverse"],
    ...
    ["kernmoment", "key moment"],
    ["kernmomenten", "key moments"],
    ["maandtegoed op", "monthly allowance used"],
    ["nog geen beeld", "no images yet"],
    ...
    ["Je bent nog geen achttien. Vraag eerst toestemming aan je ouder of voogd voordat je iets koopt. Heb je die toestemming?",
     "You are not eighteen yet. Ask a parent or guardian before you buy anything. Do you have their permission?"],
    ["Geen probleem. Dreamverse blijft gewoon werken; je kunt elke maand drie dromen laten duiden.",
     "No problem. Dreamverse keeps working; you can have three dreams read every month."],
    ["Zo ziet een kernmoment eruit", "This is what a key moment looks like"],
    ["Vier seconden uit een echte droom. Klik om te kijken — de andere vier panelen blijven stil.",
     "Four seconds from a real dream. Click to watch - the other four panels stay still."],
    ["De brandende vogel boven de jacuzzi", "The burning bird above the hot tub"],
    ["De zee die rechtop staat", "The sea standing upright"],
    ["De beker op het gras", "The cup on the grass"],
    ...
    ["droom", "dream"],
    ["dromen", "dreams"],
    ["droom te gaan.", "dream to go."],
    ["dromen te gaan.", "dreams to go."],
    ["Nog", "Still"],
    ["nacht tot je Dreamverse", "night until your Dreamverse"],
    ["nachten tot je Dreamverse", "nights until your Dreamverse"],
    ["Vanaf drie nachten schrijft Vera de lijn door al je dromen heen:",
     "From three nights on Vera writes the line running through all your dreams:"],
    ["welke plaatsen, personen en dieren terugkomen, en wat er sindsdien veranderd is.",
     "which places, people and animals return, and what has changed since."],
    ["Je chakrapilaar vult zich ondertussen al — die staat hieronder.",
     "Your chakra pillar is already filling up - it is right below."],
    ["Deze droom staat nog op zichzelf. Bij de volgende gaan de lijnen zich aftekenen.",
     "This dream still stands on its own. With the next one the lines start to show."],
    ...
    ["Meeschrijven stopte:", "Writing along stopped:"],
    ...
    ["Een token kost € 0,35, en € 0,25 als je er honderd koopt — bijna dertig procent minder.",
     "A token costs €0.35, and €0.25 if you buy a hundred - almost thirty per cent less."],
    ...
    ["Gratis · €0", "Free · €0"],
    ["Drie dromen per maand. De eerste met vijf getekende panelen, daarna de volledige duiding — en vanaf je derde droom ziet Vera wat er doorheen loopt. Geen animatie, en Vera spreek je alleen met tokens.",
     "Three dreams a month. The first with five drawn panels, then the full reading — and from your third dream Vera shows you what runs through them. No animation, and you speak to Vera only with tokens."],
    ["Lite · €2,99", "Lite · €2.99"],
    ...
    ["lite", "lite"],
    ["Plus · €7,99", "Plus · €7.99"],
    ['Zes dromen per maand, en <strong>drie bewegende kernmomenten</strong> van vier seconden met geluid — het belangrijkste moment uit je droom. Wil je er meer, dan koop je ze met tokens. Vera spreken gaat ook op tokens: twee per minuut.',
     'Six dreams a month, and <strong>three moving key moments</strong> of four seconds with sound - the most important moment of your dream. Want more? You buy them with tokens. Speaking to Vera also runs on tokens: two per minute.'],
    ["Ultra · €29,99", "Ultra · €29.99"],
    ['Tien dromen per maand, waarvan <strong>vijf met een kernmoment op het beste animatiemodel</strong>, en tien minuten met Vera inbegrepen. Daarna praat je verder op tokens.',
    ...
    ["Het kernmoment is het belangrijkste moment uit je droom: het paneel waar het om draait. Dat ene gaat bewegen, vier seconden, op het beste animatiemodel.",
     "The key moment is the most important moment of your dream: the panel it all turns on. That one starts moving, four seconds, on the best animation model."],
    ["De hele verbeelding als animatie — 30 tokens", "The whole imagining as an animation — 30 tokens"],
    ...
    ["Die animatie op het beste model — 60 tokens", "That animation on the best model — 60 tokens"],
    ["Hetzelfde, maar met de kwaliteit die je bij Ultra per kernmoment krijgt.",
     "The same, but with the quality you get per key moment on Ultra."],
    ["Praten met Vera — 2 tokens per minuut", "Talking to Vera — 2 tokens a minute"],
    ["Wordt achteraf afgerekend op de tijd die je echt gesproken hebt, naar boven afgerond per begonnen minuut.",
     "Charged afterwards on the time you actually spoke, rounded up per minute started."],
    ["Een extra droom — 3 tokens", "One extra dream — 3 tokens"],
    ["Als de dromen van je pakket op zijn en de nacht te goed was om te laten liggen.",
     "When the dreams in your plan have run out and the night was too good to let go."],

    // -- de voetnoot -------------------------------------------------------
    ['<strong>Betalen loopt via Stripe.</strong> Zij zijn de verkoper en dragen de btw af in ruim tachtig landen; je pasgegevens komen nooit bij ons. Opzeggen doe je zelf in de app en gaat in aan het eind van de betaalde maand. Gekochte tokens blijven van jou, ook daarna.',
     '<strong>Payment runs through Stripe.</strong> They are the seller and remit the VAT in over eighty countries; your card details never reach us. You cancel yourself in the app, effective at the end of the paid month. Tokens you bought stay yours, also after that.'],
    ...
    ['<strong>Het kernmoment beweegt.</strong> Het kernmoment is het belangrijkste moment uit je droom. Het model dat je verbeelding schrijft wijst zelf aan welk paneel dat is, en dat ene wordt echte animatie met geluid — vier seconden, op het snelle model bij Plus en op het beste bij Ultra. Niet elke droom krijgt er een: bij Plus drie van de zes, bij Ultra vijf van de tien, daarna op tokens. De andere vier panelen blijven stil, want twintig seconden animatie per droom kost meer dan een maandabonnement opbrengt.',
     '<strong>The key moment moves.</strong> The key moment is the most important moment of your dream. The model that writes your imagining picks which panel that is, and that one becomes real animation with sound - four seconds, on the fast model with Plus and on the best one with Ultra. Not every dream gets one: three of six on Plus, five of ten on Ultra, and tokens after that. The other four panels stay still, because twenty seconds of animation per dream costs more than a monthly subscription brings in.'],
    ...
    ["Dreamverse is nieuw en jij bent een van de eersten. Wat zou je anders willen? Eén zin is al genoeg.",
     "Dreamverse is new and you are one of the first. What would you want done differently? One sentence is plenty."],
    ["Versturen", "Send"],
    ["Nu even niet", "Not now"],
    ["Ik snapte niet wat de kwaliteitsknoppen deden.",
     "I did not understand what the quality buttons did."],
    ["Dank je. Ik lees alles wat hier binnenkomt.",
     "Thank you. I read everything that comes in here."],
    ...
    ["De animatie lukte niet", "The animation did not work"],
    ["Animatie maken —", "Making the animation —"],
    ["animatie", "animation"],
    ["kernmoment", "key moment"],
    ["Droom", "Dream"],
