...
(function () {
  ...
  [
    ...
    ["lite", "lite"],
    ["Plus · €7,99", "Plus · €7.99"],
    ['Zes dromen per maand, elk met een <strong>bewegend kernmoment</strong> van vier seconden met geluid — het belangrijkste moment uit je droom. De andere panelen zijn illustraties. Vera spreken gaat op tokens: twee per minuut.',
     'Six dreams a month, each with a <strong>moving key moment</strong> of four seconds with sound - the most important moment of your dream. The other panels are illustrations. Speaking to Vera runs on tokens: two per minute.'],
